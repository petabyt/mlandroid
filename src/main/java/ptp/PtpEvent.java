...
public class PtpEvent {
	...
	public static final int EVENTCODE_Undefined = 0x4000;
	static {
		PtpEvent.EVENTCODE_DESCRIPTIONS.put(PtpEvent.EVENTCODE_Undefined, "Undefined");
	}
	...
	static {
		PtpEvent.EVENTCODE_DESCRIPTIONS.put(PtpEvent.EVENTCODE_ObjectAdded, "ObjectAdded");
	}
	...
	static {
		PtpEvent.EVENTCODE_DESCRIPTIONS.put(PtpEvent.EVENTCODE_StoreAdded, "StoreAdded");
	}
	public static final int EVENTCODE_StoreRemoved = 0x4005;
	static {
		PtpEvent.EVENTCODE_DESCRIPTIONS.put(PtpEvent.EVENTCODE_StoreRemoved, "StoreRemove");
	}
	...
	static {
		PtpEvent.EVENTCODE_DESCRIPTIONS.put(PtpEvent.EVENTCODE_StoreFull, "StoreFull");
	}
	public static final int EVENTCODE_DeviceReset = 0x400b;
	static {
		PtpEvent.EVENTCODE_DESCRIPTIONS.put(PtpEvent.EVENTCODE_DeviceReset, "DeviceReset");
	}
	...
	static {
		PtpEvent.EVENTCODE_DESCRIPTIONS.put(PtpEvent.EVENTCODE_Internal, "InternalEvent");
	}
	...
	public PtpEvent(PtpDataType.EventCode eventCode) {
		this(eventCode, new PtpDataType.UInt32(0xFFFFFFFF), null);
	}
	public PtpEvent(PtpDataType.EventCode eventCode, PtpDataType.UInt32 transactionId) {
		this(eventCode, transactionId, null);
	}
	public PtpEvent(PtpDataType.EventCode eventCode, long[] params) {
