...
public class PtpSession {
	...
	public PtpDataType.StorageID[] getStorageIDs() throws PtpTransport.TransportError,
		...
		PtpOperation.Response response = mSession.executeTransaction(
			PtpOperation.createRequest(PtpOperation.OPSCODE_GetStorageIDs));
		response.validate();
		if (!response.isSuccess())
			throw new PtpExceptions.OperationFailed("GetStorageIds",
								response.getResponseCode());
		return ((PtpDataType.StorageIdArray)response.getData()).mArrayData;
	}

	public PtpDataType.StorageInfoDataSet getStorageInfo(PtpDataType.StorageID storageId)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		PtpOperation.Request request =
			PtpOperation.createRequest(PtpOperation.OPSCODE_GetStorageInfo);
		request.mParameters = new long[] { storageId.mValue };
		PtpOperation.Response response = mSession.executeTransaction(request);
		response.validate();
		if (!response.isSuccess())
			throw new PtpExceptions.OperationFailed("GetStorageInfo",
								response.getResponseCode());
		return (PtpDataType.StorageInfoDataSet)response.getData();
	}

	public long getNumObjects(PtpDataType.StorageID storageId)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		return getNumObjects(storageId, new PtpDataType.ObjectFormatCode(),
				     new PtpDataType.ObjectHandle());
	}

	public long getNumObjects(PtpDataType.StorageID storageId,
				  PtpDataType.ObjectHandle associationHandle)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		return getNumObjects(storageId, new PtpDataType.ObjectFormatCode(),
				     associationHandle);
	...
	public long getNumObjects(PtpDataType.StorageID storageId,
				  PtpDataType.ObjectFormatCode objectFormat)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
	...
	public long getNumObjects(PtpDataType.StorageID storageId,
		...
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		PtpOperation.Request request =
			PtpOperation.createRequest(PtpOperation.OPSCODE_GetNumObjects);
		request.mParameters = new long[] { storageId.mValue, objectFormat.mValue,
						   associationHandle.mValue };
		PtpOperation.Response response = mSession.executeTransaction(request);
		response.validate();
		if (!response.isSuccess())
			throw new PtpExceptions.OperationFailed("GetNumObjects",
								response.getResponseCode());
		return response.mParameters[0];
	}

	public PtpDataType.ObjectHandle[] getObjectHandles(PtpDataType.StorageID storageId)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		return getObjectHandles(storageId, new PtpDataType.ObjectFormatCode(),
					new PtpDataType.ObjectHandle());
	}

	public PtpDataType.ObjectHandle[] getObjectHandles(
		PtpDataType.StorageID storageId, PtpDataType.ObjectHandle associationHandle)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		return getObjectHandles(storageId, new PtpDataType.ObjectFormatCode(),
					associationHandle);
	...
	public PtpDataType.ObjectHandle[] getObjectHandles(
		PtpDataType.StorageID storageId, PtpDataType.ObjectFormatCode objectFormat)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
	...
	public PtpDataType.ObjectHandle[] getObjectHandles(
		...
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		PtpOperation.Request request =
			PtpOperation.createRequest(PtpOperation.OPSCODE_GetObjectHandles);
		request.mParameters = new long[] { storageId.mValue, objectFormat.mValue,
						   associationHandle.mValue };
		PtpOperation.Response response = mSession.executeTransaction(request);
		response.validate();
		if (!response.isSuccess())
			throw new PtpExceptions.OperationFailed("GetObjectHandles",
								response.getResponseCode());
		return ((PtpDataType.ObjectHandleArray)response.getData()).mArrayData;
	}

	public PtpDataType.ObjectInfoDataSet getObjectInfo(PtpDataType.ObjectHandle objectHandle)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		PtpOperation.Request request =
			PtpOperation.createRequest(PtpOperation.OPSCODE_GetObjectInfo);
		request.mParameters = new long[] { objectHandle.mValue };
		PtpOperation.Response response = mSession.executeTransaction(request);
		response.validate();
		if (!response.isSuccess())
			throw new PtpExceptions.OperationFailed("GetObjectInfo",
								response.getResponseCode());
		return (PtpDataType.ObjectInfoDataSet)response.getData();
	}

	public byte[] getObject(PtpDataType.ObjectHandle objectHandle)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
	...
	public byte[] getObject(PtpDataType.ObjectHandle objectHandle,
		...
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		PtpOperation.Request request =
			PtpOperation.createRequest(PtpOperation.OPSCODE_GetObject);
		request.mParameters = new long[] { objectHandle.mValue };
		PtpOperation.Response response = mSession.executeTransaction(
			request,
			listener == null ? null : new PtpTransport.Session.DataLoadListener() {
				@Override
				public void onDataLoaded(PtpOperation.Request request, long loaded,
							 long expected) {
					listener.onDataLoaded(loaded, expected);
				}
			});
		response.validate();
		if (!response.isSuccess())
			throw new PtpExceptions.OperationFailed("GetObject",
								response.getResponseCode());
		return ((PtpDataType.Object)response.getData()).mObject;
	}

	// FIXME: need to check for IMAGE, since (Sony) camera might stop otherwise...
	public byte[] getThumb(PtpDataType.ObjectHandle objectHandle)
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
	...
	public byte[] getThumb(PtpDataType.ObjectHandle objectHandle,
		...
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		PtpOperation.Request request =
			PtpOperation.createRequest(PtpOperation.OPSCODE_GetThumb);
		request.mParameters = new long[] { objectHandle.mValue };
		PtpOperation.Response response = mSession.executeTransaction(
			request,
			listener == null ? null : new PtpTransport.Session.DataLoadListener() {
		...
		response.validate();
		if (!response.isSuccess())
			throw new PtpExceptions.OperationFailed("GetThumb",
								response.getResponseCode());
		return ((PtpDataType.Object)response.getData()).mObject;
	}
	...
	public void initiateCapture_(PtpDataType.StorageID storageID,
		...
		throws PtpTransport.TransportError, PtpExceptions.PtpProtocolViolation,
		       PtpExceptions.OperationFailed {
		PtpOperation.Request request =
			PtpOperation.createRequest(PtpOperation.OPSCODE_InitiateCapture);
